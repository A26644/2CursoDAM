...
import com.example.project155.Domain.FilmList;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendRequestCategory() {
        ...
        mStringRequest2 = new StringRequest(Request.Method.GET, "https://moviesapi.ir/api/v1/genres", response -> {
            ...
            ArrayList<ItemGenre> catList = gson.fromJson(response, new TypeToken<ArrayList<ItemGenre>>() {
            }.getType());
    ...
    private void banners() {
        List<ItemsSlider> itemSliders = new ArrayList<>();
        itemSliders.add(new ItemsSlider(R.drawable.wide));
        itemSliders.add(new ItemsSlider(R.drawable.wide1));
        itemSliders.add(new ItemsSlider(R.drawable.wide3));

        viewPager2.setAdapter(new SliderAdapters(itemSliders, viewPager2));
